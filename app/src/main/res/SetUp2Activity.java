...
public class SetUp2Activity extends bilibili.kagura.com.mobiephonesafe.SetUpBaseActivity {
    ...
    public void pre_activity() {
        Intent intent = new Intent(this, bilibili.kagura.com.mobiephonesafe.SetUp1Activity.class);
        startActivity(intent);
        finish();
